...
public class SpecificReport extends Frame implements WindowListener,ActionListener
{
	 Button bexit;
	Panel p1,p2;
...
*/
      	...
      	public void actionPerformed(ActionEvent ev)
		{
				...
				try
			{
				...
				Statement s1=con.createStatement();
				ResultSet rs=s1.executeQuery("select * from Booking where BookingDate =  " + tf1.getText());
				while(rs.next())
				{
